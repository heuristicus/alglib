...
namespace tests {
    namespace sorts {
        ...
        /** 
	 * Tests that bubbleSort() works for the positive numbers
         * 
         */
	...
	TEST(BubbleSortTest, negativeNos) { 
        ...
        /** 
	 * Tests that bubbleSort() works when there are elements with the same
	 * value in the array
         * 
         */
	TEST(BubbleSortTest, sameValue) { 
	...
	/**
	 * Test that the std::vector version of bubbleSort() works with a built
	 * in type with the standard comparison operation on that type.
	 */
	TEST(BubbleSortTest, vector_basic) {
	    std::vector<int> unsorted = {4, 2, 3, 5, 1, 7};
	    std::vector<int> sorted = {1, 2, 3, 4, 5, 7};

	    alglib::sorts::bubbleSort<int>(unsorted);
	 ...
	 */
	TEST(BubbleSortTest, vector_functorBuiltin) {
	    std::vector<int> unsorted = {4, 2, 3, 5, 1, 7};
	    std::vector<int> sorted = {1, 2, 3, 4, 5, 7};
	    ...
	    alglib::sorts::bubbleSort(unsorted, compSF);
	 ...
	 */
	TEST(BubbleSortTest, vector_lambdaBuiltin) {
	    std::vector<int> unsorted = {4, 2, 3, 5, 1, 7};
	    std::vector<int> sorted = {1, 2, 3, 4, 5, 7};

	    auto comp = [](const int& a, const int& b) -> bool {return a < b;};

	    alglib::sorts::bubbleSort(unsorted, comp);
	...
	std::ostream& operator<<(std::ostream& os, const CustomClass& c){
        ...
        /**
	 * Test that the std::vector version of bubbleSort() works with a custom
	 * type and using \p operator<() implemented within that class.
	 */
	TEST(BubbleSortTest, vector_basicCustomClass) {
	    CustomClass one(1);
	    CustomClass two(2);
	    CustomClass three(3);
	    CustomClass four(4);
	    ...
	    alglib::sorts::bubbleSort(unsorted);
	 ...
	 * in type using a functor.
	 */
	TEST(BubbleSortTest, vector_functorCustomClass) {
	    CustomClass one(1);
	    CustomClass two(2);
	    CustomClass three(3);
	    CustomClass four(4);
	 ...
	 * in type using a functor.
	 */
	TEST(BubbleSortTest, vector_lambdaCustomClass) {
	    CustomClass one(1);
	    CustomClass two(2);
	    CustomClass three(3);
	    CustomClass four(4);
